...
pub fn add_padding_to_center_string(
    text: &str,
    padding_symbol: char,
    ...
    format!(
        "{}{}{}",
        make_repeated_char_string(padding_symbol, left_padding_length),
        text,
        make_repeated_char_string(padding_symbol, right_padding_length)
    )
}
